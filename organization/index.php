...
<section class="wrapper style2 organization">
	<div class="inner">
...
<section class="wrapper style1 organization">
	<div class="inner">
		<div class="flex flex-2">
			<div class="col"><div>
			...
			<div class="col first">
				<div class="image fit">
					<img src="/assets/images/organigram.png" alt="Organizational structure diagram of NeurotechEU university"/>
				</div>
			</div>
		</div>
	</div>
